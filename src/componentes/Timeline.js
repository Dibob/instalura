...
export default class Timeline extends Component {
  ...
  componentWillMount() {
    ...
    PubSub.subscribe('atualiza-liker', (topico, infoLiker) => {
      ...
      const possivelLiker = fotoAchada.likers.find(liker => liker.login === infoLiker.login);
    ...
    PubSub.subscribe('novos-comentarios', (topico, infoComentario) => {
      const fotoAchada = this.state.fotos.find(foto => foto.id === infoComentario.foto.id);
